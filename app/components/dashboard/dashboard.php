...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-primary">
			...
			<div id="panel-body-1" class="panel-body"></div>
		</div>
	</div>
	<div class="col-md-4">
		<div class="panel panel-success">
			...
			<div id="panel-body-2" class="panel-body"></div>
		</div>
	</div>
	<div class="col-md-4">
		<div class="panel panel-default">
			...
			<div id="panel-body-3" class="panel-body"></div>
	</div>
</div>
</div>
<div class="row">
	...
	<div class="col-md-6">
		<div class="panel panel-warning">
			...
			<div id="panel-body-5" class="panel-body"></div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-danger">
			...
			<div id="panel-body-6" class="panel-body">
				<div id="pie-bar-chart" class="chart">
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	var w = $('#bar-chart').width() / data.length,
	    h = 100;
...
<script>
	...
	dashboard('#pie-bar-chart',freqData);
</script>